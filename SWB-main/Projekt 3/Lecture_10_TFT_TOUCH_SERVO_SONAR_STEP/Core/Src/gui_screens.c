...
static const uint8_t GLYPH_J[5] = {0x20, 0x40, 0x40, 0x41, 0x3F};
...
static const uint8_t GLYPH_g[5] = {0x0C, 0x52, 0x52, 0x52, 0x3C};
...
static const uint8_t GLYPH_COMMA[5] = {0x00, 0x50, 0x30, 0x00, 0x00};
